...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/.0.28.4@css-loader/index.js!./css.css", function() {
			var newContent = require("!!../node_modules/.0.28.4@css-loader/index.js!./css.css");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_css__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__css_css__);
/**
...
let app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  ...
  template: '<div id="name" class="box">' + '{{name}}' + '</div>'
});
